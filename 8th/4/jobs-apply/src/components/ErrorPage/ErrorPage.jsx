...
export function ErrorPage() {
  return (
<section className="flex items-center justify-center h-screen sm:p-16 text-black">
	<div className="container flex flex-col items-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
